...
export class ALRComponent implements OnInit {
  ...
  vidaALR:number = 0;
  manaALR:number = 0;
  sanidadeALR:number = 0;
  lutarALR:number = 0;
  armasPesadasALR:number = 0;
  forBruALR:number = 0;
  esquivaALR:number = 0;
  bloqueioALR:number = 0;
  counterALR:number = 0;
  armasLevesALR:number = 0;
  armasDeFogoALR:number = 0;
  precisaoALR:number = 0;
  findALR:number = 0;
  escutarALR:number = 0;
  intuitionALR:number = 0;
  resFisicaALR:number = 0;
  resMentalALR:number = 0;
  resEspiritualALR:number = 0;
  firstAidALR:number = 0;
  medForenseALR:number = 0;
  medicinaALR:number = 0;
  velocidadeALR:number = 0;
  escaladaALR:number = 0;
  acrobaciaALR:number = 0;
  magiaALR:number = 0;
  intelectoALR:number = 0;
  conhecimentoALR:number = 0;
  persuasaoALR:number = 0;
  diplomaciaALR:number = 0;
  intimidacaoALR:number = 0;
